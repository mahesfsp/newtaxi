...
<body ng-app="App" class="<?php echo e((!isset($exception)) ? (Route::current()->uri() == '/' ? 'homepage' : '') : ''); ?> commonpage"><?php /**PATH C:\xampp\htdocs\web-and-admin-backend\resources\views/common/head.blade.php ENDPATH**/ ?>